...
for ($i = 0; $i < (2); $i += (1/60)) {
   ...
   $n++;
   #`./calcdata 34.0007 -81.0348 $i > $txt; convert -size 1024x1024 -depth 8 RGBA:out.bin $file`;
   `./calcdata 85 -125.5 $i > $txt; convert -size 1024x1024 -depth 8 RGBA:out.bin $file`;
}
